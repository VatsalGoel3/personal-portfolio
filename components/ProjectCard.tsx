...
export default function ProjectCard({
  ...
  return (
    <Link href={`/projects#${title.toLowerCase().replace(/\s+/g, '-')}`}>
      <a className="group relative block bg-gray-800/50 rounded-xl overflow-hidden border border-gray-700/50 hover:border-emerald-500/50 transition-all duration-300 h-full flex flex-col">
        {/* Image Container */}
